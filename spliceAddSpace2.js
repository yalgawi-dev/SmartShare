const fs = require('fs');
const lines = fs.readFileSync('src/app/context/SpacesContext.tsx', 'utf-8').split('\n');

const start = lines.findIndex(l => l.includes('const addSpace ='));
const end = lines.findIndex((l, i) => i > start && l.includes('catch(console.error);'));
...
console.log('Spliced addSpace successfully');
