...
c = c.replace(
  /const addSpace = \(spaceData[\s\S]*?setDoc\(doc\(db, 'spaces', newSpace\.id\), newSpace\)\.catch\(console\.error\);\n  \};/,
...
console.log('Fixed addSpace using regex to avoid hebrew corruption matching');
