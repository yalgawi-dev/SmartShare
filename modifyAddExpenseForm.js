...
// 1. Add states for isCredit and isStoreCredit
...
// 2. Add the UI toggle at the top of the form
const toggleUI = `
...
content = content.replace(
  /\{!\(isScanning \|\| isAnalyzing\) && \(\s*<form onSubmit=\{handleAddExpense\}/m,
  "{!(isScanning || isAnalyzing) && (\n        <form onSubmit={handleAddExpense}>\n" + toggleUI
);

fs.writeFileSync("src/components/widgets/Finance/FinanceAddExpenseForm.tsx", content, "utf-8");
console.log("Updated FinanceAddExpenseForm.tsx");
